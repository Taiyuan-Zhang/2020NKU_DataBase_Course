...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        // some code goes here
        return (int)Math.floor((BufferPool.getPageSize()*8*1.0)/(td.getSize()*8*1.0+1));
    ...
    private int getHeaderSize() {
        // some code goes here
        return (int)Math.ceil(this.getNumTuples()*1.0/(8*1.0));
    }
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if(this.tuples[tupleno] == null||!pid.equals(this.pid)||!isSlotUsed(tupleno)){
            throw new DbException("tuple does not exist in this page or tuple's slot is empty");
        }
    ...
    public boolean isSlotUsed(int i) {
        // some code goes here
        //method 1
        int slotStatus = (header[i/8] >> (i%8)) & 1;
        return slotStatus == 1;
        //method 2
